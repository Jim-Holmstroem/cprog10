    ...
    //these varibles shouldn't be accessed outside "vector.h"
    const std::size_t BYTE_SIZE = 8;
    const std::size_t BOOL_PER_INT = BYTE_SIZE*sizeof(int); //sätts denhär i compiletime eller runtime??
	...
	public:
        ...
        void print(){std::cout << "funkar bra" << std::endl;};
    };
