    ...
    class Matrix{
     public:
        ...
        private:
            friend std::istream& operator>>( std::istream&, Matrix& ); //vola kompis låter cin får matris komma åt mina privata grejer
        };
     ...
     private:
        ...
        friend std::istream& operator>> ( std::istream&, Matrix& ); // tested when inputting to an existing matrix with different dimension
    };
