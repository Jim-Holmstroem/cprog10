...
//unsigned int counter[] ={NUMBER_OF_VECTORS,NUMBER_OF_VECTORS,NUMBER_OF_VECTORS,NUMBER_OF_VECTORS,NUMBER_OF_VECTORS,NUMBER_OF_VECTORS,NUMBER_OF_VECTORS,NUMBER_OF_VECTORS};
    ...
    Vector<bool> newcopy;
    std::copy(v1.begin()+2, v1.end()-3, std::back_inserter(newcopy));
    std::cout << "newcopy: ";
    newcopy.print();
    ...
    std::sort(v1.begin(), v1.end());
    v1.print();
    std::cout << "count true: " << std::count(v1.begin(), v1.end(), true) << std::endl; //TODO count changes if size > 32
