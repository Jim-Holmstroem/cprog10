...
//    k_time(&rawtime);
 ...
 //   _day = timeinfo->tm_mday;
    ...
    *this += ( this->mod_julian_day_for_greg() - this->mod_julian_day() ); //convert from Gregorian to Julian by adding the difference of number of days by looking at MJD
        ...
        //cout << "in Julian::setCurrentTime()" << endl;
...
int lab2::Julian::week_day() const{
    ...
    return (mod_julian_day() - mjd_010103 )% 7 + 1; //since mod_julian_day is negative for dates before Julian(1858-11-5) we use an early monday (in this case 01-01-03) as a reference
};
