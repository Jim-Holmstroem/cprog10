...
bool lab2::Date::isDateOutOfRange(){
    //week_day will return incorrect(maybe negative) values for days smaller than Gregorian(0001,01,01) resp. Julian(0001,01,03)
    return (_year<1||_year>3000||month2small()||day2small()||month2big()||day2big()||mod_julian_day()<(-678575) );
};
