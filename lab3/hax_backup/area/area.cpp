...
SerializableVector<hax::Character*> hax::Area::chars() const{
    return vec_char;
}
...
SerializableVector<hax::Character*>::iterator hax::Area::findChar(Character* ch){
    SerializableVector<Character*>::iterator it;
    for(it = vec_char.begin(); it != vec_char.end(); it++){
...
SerializableVector<hax::Object*>::iterator hax::Area::findObject(Object* ob){
