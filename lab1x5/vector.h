...
namespace constant{
   ...
   //.def is a file to define constant data ex: const char lookup8bit[] = {0x04,0x02, ... ,0x00};
   #include "lookup8bit.def"
   #include "lookup16bit.def"
...
};//end of Vector<bool> template specialization
#endif
